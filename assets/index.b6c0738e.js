...
`,Y3=$.div`
  ${({hasManyEvolutions:e,showShadow:t,theme:{boxShadow:n}})=>F`
    ...
    box-shadow: ${t?n.dark:""};
  `}
`,q3=({url:e})=>{const[t,n]=x.exports.useState(),r=t==null?void 0:t.filter(c=>c.canEvolve),i=t==null?void 0:t.filter(c=>!c.canEvolve),o=(c,f)=>c.includes("https://pokeapi.co/api/v2/pokemon-species/")?c.replace("https://pokeapi.co/api/v2/pokemon-species/","").replace("/",""):f,a=x.exports.useMemo(()=>[],[]),s=x.exports.useCallback(c=>{if(!c.evolves_to.length){a.push({id:o(c.species.url,c.species.name),name:c.species.name,canEvolve:!1}),n(a);return}a.length||a.push({id:o(c.species.url,c.species.name),name:c.species.name,canEvolve:!0}),c.evolves_to.forEach(f=>{if(!f.evolves_to.length){a.push({id:o(f.species.url,f.species.name),name:f.species.name,canEvolve:!1}),n(a);return}a.push({id:o(f.species.url,f.species.name),name:f.species.name,canEvolve:!0}),n(a),s(f)})},[a]),{isFetching:l}=c0(["pokemonChain",e],()=>UE(e),{onSuccess:c=>s(c==null?void 0:c.chain),refetchOnWindowFocus:!1}),{colors:u}=pr();return w(G3,{children:l?w(ul,{}):N(xo,{children:[w(K3,{children:"EVOLUTION CHAIN:"}),N(_c,{children:[r!=null&&r.length?r.map(c=>N(qg,{children:[w(Oc,{pokemon:c.id,light:!0},c.name),c.canEvolve&&w(Xg,{children:w(Ne,{icon:L0,color:u.black,size:"xl"})})]},c.name)):null,i!=null&&i.length?w(Y3,{showShadow:i.length>1,hasManyEvolutions:i.length>3,children:i.map(c=>w("div",{children:w(Oc,{pokemon:c.id,light:!0},c.name)},c.name))}):null]})]})})},X3=()=>{const{colors:e}=pr();return w(_c,{children:N(_c,{children:[N(qg,{children:[w(jh,{baseColor:e.lightGray}),w(Xg,{children:w(Ne,{icon:L0,color:e.mediumGray,size:"xl"})})]}),w(jh,{baseColor:e.lightGray})]})})},J3=$.div`
