...
`,sc=({pokemon:e,light:t=!1})=>{var a;const[n,r]=y.exports.useState();y.exports.useEffect(()=>{(async()=>{const l=await ii(e);r(l)})()},[e]);const{typesColors:o,colors:i}=ur();return x(IE,{light:t,children:n?x(xn,{to:`/pokemon/${n.id}`,children:R(LE,{light:t,children:[R(ME,{secondary:(a=o[n.types[0].type.name])==null?void 0:a.secondaryColor,children:[R(DE,{children:["#",n.id]}),x("h3",{children:n.species.name})]}),x("img",{src:n.sprites.other.dream_world.front_default||n.sprites.other["official-artwork"].front_default||n.sprites.front_default,alt:n.name}),x(zE,{children:n.types.map(s=>x(Hf,{typeName:s.type.name},s.type.name))})]})}):x(Gs,{color:t?i.black:""})})},FE=C.div`
  ...
  gap: 1.5rem;
  padding: 50px 0;
`,jE=({pokemonList:e})=>x(FE,{children:e.map((t,n)=>x(sc,{pokemon:t.name},`${t.name}-${n}`))}),UE=20;function BE(e){const[t,n]=y.exports.useState(!0),[r,o]=y.exports.useState(!1),[i,a]=y.exports.useState([]),s=y.exports.useCallback(async()=>{try{n(!0);const l=await bE(e,UE);a(u=>[...u,...l.results]),n(!1)}catch(l){n(!1),o(!!l)}},[e]);return y.exports.useEffect(()=>{s()},[s,e]),{loading:t,error:r,allPokemonList:i}}const WE=C.div`
  ${({theme:{spacing:e}})=>T`
    width: 100%;
    display: flex;
    flex-direction: column;
...
`,VE=C.div`
  ...
  `}
`,GE=20;function YE(){const[e,t]=y.exports.useState(0),{allPokemonList:n,loading:r}=BE(e),o=y.exports.useRef(null),i=y.exports.useCallback(a=>{a[0].isIntersecting&&t(l=>l+GE)},[]);return y.exports.useEffect(()=>{const a={root:null,rootMargin:"20px",threshold:0},s=new IntersectionObserver(i,a);o.current&&s.observe(o.current)},[i]),y.exports.useEffect(()=>{window.onbeforeunload=function(){window.scrollTo(0,0)}},[]),R(WE,{children:[x(VE,{children:x("p",{children:"Here's a list of Pokemon from every generation. Click on any of them to get information about their type, stats, and evolution chain!"})}),R(HE,{children:[!!(n!=null&&n.length)&&x(jE,{pokemonList:n}),x("div",{ref:o}),r&&x(Gs,{})]})]})}const KE=C.div`
  ${({theme:{colors:e}})=>T`
    display: flex;
    flex-direction: column;
    justify-content: center;
